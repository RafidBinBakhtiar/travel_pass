...
// ── Shared Auth Shell (logo → scrollable card → BgImage footer) ────────────────
            ...
            children: [
              ...
              if (_isMobileLogin)
                ...
                TextFormField(
                  ...
                  validator: (v) =>
                      (v == null || v.isEmpty) ? l10n.emailNotRegistered : null,
                ),
              ...
              TextFormField(
                ...
                validator: (v) =>
                    (v == null || v.isEmpty) ? l10n.wrongPassword : null,
              ),
              ...
              Row(
                ...
                children: [
                  Text(l10n.noAccount, style: TextStyle(fontFamily: font)),
                  GestureDetector(
